...
describe 'navigate' do
  ...
  let(:post) do
    Post.create(date: Date.today, description: "Description", user_id: user.id, daily_hours: 12.5)
  end
  ...
  describe 'delete' do
    it 'can be deleted' do
      ...
      post_to_delete = Post.create(date: Date.today, description: 'asdf', user_id: delete_user.id, daily_hours: 3.5)
